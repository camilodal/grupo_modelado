...
begin
	primera_ola= select(primera_ola_arg, [:Week, :New_cases])
	plot(primera_ola.Week, primera_ola.New_cases, title="Primera ola (casos por día)", legend=false, ylabel="Cantidad de casos", xlabel= "Semana")
end


# ╔═╡ 83fc7482-8a46-4842-83cb-d05d6f6d67da
begin
	segunda_ola= select(segunda_ola_arg, [:Week, :New_cases])
	plot(segunda_ola.Week, segunda_ola.New_cases, title="Segunda ola (casos por día)", legend=false, ylabel="Cantidad de casos", xlabel= "Semana")
end
...
# ╔═╡ 9a9ff1d1-3b6c-48bd-bd46-69b7956c7eaa
md"""
	!!! e
		Estimamos los parametros con funciones de costo"""
...
# ╔═╡ 38df9cf2-40e1-4dfe-b965-8ae7738073d7
begin
	optprob₂ = OptimizationProblem(func,p̄,lb=zeros(2),ub=ones(2))
	p̄₂       = solve(optprob,NelderMead(),maxiters=100000)
end

# ╔═╡ dc464f6b-3b9f-4f1d-8f32-220d2a73f439
begin
	optsol  = solve(remake(prob,u0=[0.8, 0.2,0],p=p̄₂))
	#sol₀    = solve(remake(prob,p=[0.025,0.001,0.02,0.002]))
	plot(optsol)
	scatter!(1:42,primera_ola.New_cases)
end

# ╔═╡ 1c5e32fa-c6c5-494d-bf30-118c7ecac1c1
md"""
	!!! f
		Dejamos libres los datos iniciales"""

# ╔═╡ a3f49a09-9304-4acc-8918-936d1897d7e4
